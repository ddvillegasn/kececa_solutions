  ...
  return (
    <div className="container mx-auto px-4 pt-40 pb-16">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {/* Misión */}
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 dark:text-white">Nuestra Misión</h2>
          <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        {/* Visión */}
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 dark:text-white">Nuestra Visión</h2>
          <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        {/* Valores */}
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900 dark:text-white">Nuestros Valores</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg md:text-xl font-semibold mb-2 text-blue-900 dark:text-blue-300">Innovación Continua</h3>
            ...
            <div className="bg-purple-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg md:text-xl font-semibold mb-2 text-purple-900 dark:text-purple-300">Orientación a Resultados</h3>
            ...
            <div className="bg-green-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg md:text-xl font-semibold mb-2 text-green-900 dark:text-green-300">Compromiso Real</h3>
            ...
            <div className="bg-yellow-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg md:text-xl font-semibold mb-2 text-yellow-900 dark:text-yellow-300">Seguridad e Integridad</h3>
            ...
            <div className="bg-pink-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg md:text-xl font-semibold mb-2 text-pink-900 dark:text-pink-300">Accesibilidad Tecnológica</h3>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg md:text-xl font-semibold mb-2 text-gray-900 dark:text-gray-300">Acompañamiento Humano</h3>
        ...
        {/* Diferenciadores */}
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 dark:text-white">¿Qué Nos Diferencia?</h2>
        ...
        {/* Equipo */}
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900 dark:text-white">Nuestro Equipo</h2>
        ...
        {/* Enfoque de Trabajo */}
        <section>
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900 dark:text-white">Nuestro Enfoque de Trabajo</h2>
