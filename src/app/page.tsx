            ...
            <div>
              ...
              <FadeIn delay={0.3}>
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                  En <span className="font-semibold text-blue-600">INTEGRA SOLUTIONS</span>, ayudamos a negocios locales, emprendedores y PYMES a modernizarse con tecnología práctica, accesible y enfocada en resultados.
                </p>
              </FadeIn>
